...
class InceptionI3d(nn.Module):
    ...
    def __init__(self, num_classes=400, spatial_squeeze=True,
        ...
        self.end_points = {}
        if in_channels == 1:
            end_point = 'Conv3d_1a_7x7_1'
            self.VALID_ENDPOINTS = ('Conv3d_1a_7x7_1',) + self.VALID_ENDPOINTS[1:]
        else:
        ...
        self.avg_pool_liner = nn.AvgPool3d(kernel_size=(8, 7, 7))
        self.build()
